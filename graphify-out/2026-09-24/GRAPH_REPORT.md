# Graph Report - IPMI-KVM-Paste-MacOS  (2026-09-23)

## Corpus Check
- Corpus is ~2,462 words - fits in a single context window. You may not need a graph.
...
Cohesion: 0.13
Nodes (12): dataclasses, SettingsDialog, json, create_logger(), Application activity logging., logging, pathlib, QDialog (+4 more)
...
## Knowledge Gaps
- **8 isolated node(s):** `build-macos.sh script`, `PYINSTALLER_CONFIG_DIR`, `macOS`, `Clipboard paste`, `Accessibility permission` (+3 more)
...
- **What connects `build-macos.sh script`, `PYINSTALLER_CONFIG_DIR`, `macOS` to the rest of the system?**
